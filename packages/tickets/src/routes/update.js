...
var updated_1 = require("../events/publishers/tickets/updated");
...
router.put('/api/tickets/:id', common_1.requireAuth, validateInput, common_1.validateRequest, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ticket, _a, title, price;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                return [4 /*yield*/, new updated_1["default"](nats_client_1["default"].client).publish({ id: ticket.id, title: ticket.title, price: ticket.price, owner: ticket.owner })];
            case 3:
                _b.sent();
                res.json(ticket);
                return [2 /*return*/];
