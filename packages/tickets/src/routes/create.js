...
var created_1 = require("../events/publishers/tickets/created");
...
router.post('/api/tickets', common_1.requireAuth, validateInput, common_1.validateRequest, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, price, ticket;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, title = _a.title, price = _a.price;
                ticket = new ticket_1["default"]({ title: title, price: price, owner: req.currentUser.id });
